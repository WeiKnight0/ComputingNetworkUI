...
class SetUserNodeWidget(QWidget):
    ...
    def __init__(self, user_node, parent=None):
        ...
        # 获取UI控件
        self.radio_button = self.ui.findChild(QRadioButton, 'radioButton')  # 获取自动配置IP的单选按钮
        ...
        self.update_ip_mask_fields()  # 根据初始状态更新IP和子网掩码字段
        self.radio_button.toggled.connect(self.update_ip_mask_fields) # 连接radioButton的状态变化事件
